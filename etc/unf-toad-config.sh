    ...
    *)
    if [ -z "${BQMAMMOUTH}" ];
        then
            ...
            export LD_LIBRARY_PATH=$APPDIR/gcc-toad/lib64:$APPDIR/osmesa/lib:$APPDIR/lib:$APPDIR/vtk/lib:$APPDIR/python-2.7/lib:$LD_LIBRARY_PATH
            export PATH=$APPDIR/gcc-toad/bin:$APPDIR/python-2.7/bin:$APPDIR/imagemagik-6.9/bin:$PATH
