...
a {{number_array_coil}} -channel head coil and a 3.0T Siemens TIM TRIO magnetic resonance
imaging system (T1: TR= {{t1_tr}} ms, TE = {{t1_te}} ms, TI = {{t1_ti}} ms, Flip Angle =
{{t1_flipangle}} &deg;, 176 slices, FoV = {{t1_fov}} mm<sup>2</sup>, matrix size = {{t1_mat}}, voxel size = {{t1_voxelsize}}
...
<p>These tools were wrapped in the TOAD pipeline developed in the Functional Neuroimaging Unit (UNF) from the Centre de Recherche de l’Institut Universitaire de Gériatrie de Montréal (<a href='http://www.unf-montreal.ca/toad'>http://www.unf-montreal.ca/toad</a></p>
