...
class TensorMrtrix(GenericTask):
    ...
    def isDirty(self):
        ...
        return Images((self.getImage(self.workingDir, "dwi", "tensor"), "mrtrix tensor"),
    ...
    def qaSupplier(self):
        ...
        for prefix, description in tags:
            niftiImage = self.getImage(self.workingDir, 'dwi', prefix)
            if niftiImage:
                pngImage = self.buildName(niftiImage, softwareName, 'png')
                self.slicerPng(niftiImage, pngImage, boundaries=mask)
